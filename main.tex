...
\begin{table}[ht]
    ...
    \begin{tabular}{lcccc}
        ...
        \bottomrule
    \end{tabular}
    \caption{Parameter and memory footprint comparison between the original Sen2Fire baseline U-Net and our width-reduced compact variant. Full evaluation metrics for these models can be found in Table~\ref{tab:classical-runs}.}
