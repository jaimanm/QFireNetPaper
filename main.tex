...
A direct consequence of this analysis is that dropping the aerosol channel at training time (\texttt{mode = 4}, SWIR-only) should narrow the train/test gap, even though aerosol is the single most-separating band on the training split (see Appendix~\ref{sec:bandaucs}). We test this on the classical FPN variant from Section~\ref{sec:fpn-method}.
