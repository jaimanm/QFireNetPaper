...
\begin{itemize}[leftmargin=2em,topsep=2pt,itemsep=2pt]
    \item We implement and compare two variational quantum bottleneck ansatzes --- QuFeX and QB-Net --- as drop-in replacements for the deepest U-Net convolution. Under matched conditions on Sen2Fire, both modestly exceed a classical baseline (QB-Net Fire $F_1 = 31.18$, QuFeX $30.79$, vs.\ the baseline $28.71$).
